# Secure the supply chain — Production tutorial

Use ECR signing/verification workflows, keyless or KMS-backed signing, provenance attestations, and promotion gates. The trust model is the same.
...
**Security focus:** Track provenance from source to digest, registry, admission or policy decision, and the running workload. A tag alone is weak evidence.
