# Guided implementation — Perform static analysis of Kubernetes manifests
...
Track provenance from source to digest, registry, admission or policy decision, and the running workload. A tag alone is weak evidence.
