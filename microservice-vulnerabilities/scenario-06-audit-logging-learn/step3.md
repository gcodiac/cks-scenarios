# Guided implementation — Configure and use audit logging
...
Distinguish the API request, audit policy level, audit backend, and resulting record. Filter by user, verb, resource, namespace, and response status.
