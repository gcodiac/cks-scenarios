# Implement container runtime security — Production tutorial

Use admission policy, hardened images, runtime detection, and immutable nodes. The cloud does not change the container boundary.
