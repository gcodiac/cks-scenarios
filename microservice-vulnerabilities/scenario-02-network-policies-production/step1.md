# Use NetworkPolicies — Production tutorial

On EKS, combine NetworkPolicy with VPC security groups and observability. Do not assume a VPC rule provides pod identity or namespace intent.
