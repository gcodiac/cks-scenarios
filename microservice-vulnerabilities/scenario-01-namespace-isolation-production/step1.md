# Use namespace isolation — Production tutorial

Use namespace-per-team or workload boundary conventions, quotas, labels, and admission policy. EKS namespaces work the same way.
