# Use Pod Security Standards — Production tutorial

Use namespace labels as a baseline and a policy engine for organization-specific rules. EKS supports the same Kubernetes admission model.
