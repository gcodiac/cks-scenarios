# Configure appropriate OS-level security domains — Production tutorial

Bake profiles into node images or distribute them through a controlled profile pipeline. AWS nodes still enforce the same Linux mechanisms.
