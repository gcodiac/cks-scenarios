# Minimize the host OS footprint — Production tutorial

Use hardened EKS/Bottlerocket or approved AMIs, immutable replacement, patch rings, and drift detection. Do not hand-tune long-lived nodes.
