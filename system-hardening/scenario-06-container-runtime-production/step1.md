# Securely use the container runtime — Production tutorial

Use hardened node images, managed patching, runtime metrics, and least-privilege access. AWS-managed node groups still require runtime and workload hardening.
