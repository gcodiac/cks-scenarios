# Minimize external access — Production tutorial

AWS security groups, NACLs, private subnets, SSM Session Manager, and load balancers provide surrounding controls. Keep Kubernetes and VPC rules aligned.
