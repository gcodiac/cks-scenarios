# Minimize the host OS footprint — Inferno
...
Remove or disable an unnecessary service from the supplied node, preserve kubelet/container runtime dependencies, and verify the node returns Ready.
