# Securely configure the host OS — Inferno
...
Apply the requested host setting through the correct configuration source, reload safely, and verify both the value and node health.
