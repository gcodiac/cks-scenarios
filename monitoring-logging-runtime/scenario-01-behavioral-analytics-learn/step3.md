# Guided implementation — Perform behavioral analytics of system and workload
...
Build a baseline first, identify the process or syscall/network anomaly, preserve evidence, and separate detection from containment.
