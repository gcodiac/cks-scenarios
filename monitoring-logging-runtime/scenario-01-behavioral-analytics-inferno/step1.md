# Perform behavioral analytics of system and workload — Inferno
...
Investigate the supplied event, separate signal from noise, and document the workload, identity, command, node, and response.
