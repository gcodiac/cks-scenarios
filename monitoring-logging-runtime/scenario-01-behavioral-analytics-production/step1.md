# Perform behavioral analytics of system and workload — Production tutorial

Use runtime detection, SIEM correlation, and tested runbooks. EKS changes log sources and integrations, not the investigation questions.
