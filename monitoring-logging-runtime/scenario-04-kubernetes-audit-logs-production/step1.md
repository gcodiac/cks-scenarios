# Understand and use audit logs — Production tutorial

Send EKS control-plane audit logs to CloudWatch or a SIEM, set retention and alerting, and protect access to the evidence.
