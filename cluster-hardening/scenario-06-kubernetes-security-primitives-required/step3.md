# Guided implementation — Understand and implement Kubernetes security primitives
...
Reason from the workload boundary: user, capabilities, seccomp, filesystem, privilege escalation, and admission enforcement.
