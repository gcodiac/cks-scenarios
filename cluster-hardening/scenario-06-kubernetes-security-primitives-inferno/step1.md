# Understand and implement Kubernetes security primitives — Inferno
...
Implement the requested combination without confusing authentication with authorization or a NetworkPolicy with a process sandbox. Verify each layer independently.
