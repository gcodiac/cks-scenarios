# Guided implementation — Use secrets to store sensitive data
...
Treat the Secret as data with an access policy: inspect references, mount or environment behavior, RBAC, and the fact that base64 is not encryption.
