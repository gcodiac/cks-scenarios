# Guided implementation — Use Role Based Access Controls (RBAC) to minimize exposure
...
Separate authentication, identity, authorization, and admission. Test permissions with kubectl auth can-i and keep grants namespace-scoped.
