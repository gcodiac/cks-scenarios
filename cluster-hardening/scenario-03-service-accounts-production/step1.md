# Exercise caution in using service accounts — Production tutorial

Use EKS Pod Identity or IRSA for AWS APIs and Kubernetes service accounts for Kubernetes APIs. Rotate trust relationships and review unused identities.
