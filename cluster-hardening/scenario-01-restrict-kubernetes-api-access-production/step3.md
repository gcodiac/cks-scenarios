# Guided implementation — Restrict access to the Kubernetes API
...
Identify the asset, trust boundary, control point, evidence source, and smallest reversible remediation.
