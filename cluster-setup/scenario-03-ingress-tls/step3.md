# Use Ingress and Egress rules and TLS to restrict network access – Inferno

Placeholder advanced task for **Use Ingress and Egress rules and TLS to restrict network access**.
