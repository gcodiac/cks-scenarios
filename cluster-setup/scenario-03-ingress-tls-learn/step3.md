# Guided implementation — Use Ingress and Egress Rules to Restrict Network Access with TLS
...
Map selectors and namespaces first, then reason about allowed paths, DNS, ports, and the direction of traffic.
